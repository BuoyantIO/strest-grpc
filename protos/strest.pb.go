...
func (*ResponseSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_strest_ee10d4758df534aa, []int{0}
}
...
func (*StreamingResponseSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_strest_ee10d4758df534aa, []int{1}
}
...
func (*ResponseReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_strest_ee10d4758df534aa, []int{2}
}
...
func init() { proto.RegisterFile("strest.proto", fileDescriptor_strest_ee10d4758df534aa) }

var fileDescriptor_strest_ee10d4758df534aa = []byte{
